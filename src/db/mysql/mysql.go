...
func OpenDB() (*sql.DB, error) {
	...
	tableName = append(tableName, "messages", "historys", "product_stock_handle_records")
	...
	tableDdl = append(tableDdl, messageDdl, historyTrackDdl, productStockHandleHistoryDdl)
