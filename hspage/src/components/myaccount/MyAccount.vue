  ...
  <div>
    ...
    <div class="contentmainwrapper">
      ...
      <div class="accountinfobox" id="personalinfo">
        <h3>个人信息</h3>
        <p v-if="emailnotbeyoudiamond.com" id="updatewarning"><span class="glyphicon glyphicon-exclamation-sign"></span> 为了交易顺利，请更新这里的信息 </p>
        <div>
          <form action="" method="post">
            <p><label>姓名</label><input type="text" name="name_new" id="account_name" value="<?php echo $name; ?>"></p>
            <p><label>电话</label><input type="text" name="tel_new" id="account_tel" value="<?php echo $tel; ?>"></p>
            <p><label>微信ID</label><input type="text" name="wechatid_new" id="account_wechatid" value="<?php echo $wechat_id; ?>"></p>
            <p><label>地址</label><input type="text" name="address_new" id="account_address" value="<?php echo $address; ?>"></p>
            <p><label>邮箱</label><input type="text" name="email" value="<?php echo $email; ?>"></p>
            <p><label>密码</label><input type="text" name="website_password" value="<?php echo $website_password; ?>"></p>
      ...
      <div id="qrcodebg">
        ...
        <div v-if="wechat_open_idwechatnameicon">
          <div id="qrcodebg-watch">
            ...
            <button id="x-it" onclick="x()" style="position:absolute; bottom:25px; right:25px;">关闭</button>
          </div>
        </div>
      </div>
