    ...
    <div id="maincontentbox">
      ...
      <div v-if="userprofile===''">
        ...
        <p class="link-old-account-box">
          ...
          <button id="showqrsignin_btn" v-on:click="showqrSignIn()" type="button">
        ...
        <form id="signin-form" style="display:none;">
          ...
          <p v-if="referer!==''" id="recommend-ticket-box">
            ...
            <input type="text" disabled="disabled" id="therecommendticketcode" name="therecommendticketcode" :value="referer" />
          </p>
        ...
        <form id="signup-form">
          ...
          <input name="newaccountemail" type="hidden" class="inputtextforloginform" id="newaccountemail" :value="wechatopenID+'@beyoudiamond.com'" />
          <input name="newaccountpassword" type="hidden" class="inputtextforloginform" id="newaccountpassword" :value="wechatopenID" />
          <input v-if="referer!==''" type="hidden" id="therecommendticketcode" name="therecommendticketcode" :value="referer" />
        </form>
      </div>
      <div v-else>
